 ...
 *
 * <p>Đây là cầu nối duy nhất để Frontend biết ngưỡng Sync/Async, các định dạng và
 * chế độ xuất hỗ trợ cùng chu kỳ polling — không cần hard-code trùng lặp ở Frontend.</p>
 *
 ...
 * @param supportedFormats      danh sách định dạng hỗ trợ (EXCEL, PDF)
 * @param supportedModes        danh sách chế độ điều phối (AUTO, SYNC, ASYNC)
